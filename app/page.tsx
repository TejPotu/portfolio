...
const featuredProjects: Project[] = [
  {
    ...
    longDescription:
      "Collapses a 4-hour clinical referral workflow into ~5 minutes by automating historical case matching, specialist facility location, imaging comparison, and referral documentation. Uses medical-specialized AI models (MedGemma, MedSiglip) for chest X-ray analysis and clinical text processing.",
    tech: ["FastAPI", "React", "CrewAI", "Google Gemini", "MedGemma", "Qdrant", "GCP"],
...
const otherProjects: Project[] = [
  ...
  {
    title: "MedGemma",
    description: "Medical AI experiments",
    longDescription:
      "Experimental work with Google's MedGemma model for medical AI applications, exploring domain-specific language models for clinical reasoning and medical knowledge extraction.",
    tech: ["MedGemma", "Medical AI", "LLM"],
    link: "https://github.com/TejPotu/MedGemma",
    language: "Jupyter Notebook",
  ...
  },
  {
    ...
    longDescription:
      "Data-driven analysis examining the impact of COVID-19 on US stock markets with market trend visualizations, sector-level breakdowns, and statistical analysis of pandemic-related volatility.",
  ...
  {
    title: "Adaptive Gaussian Fitting",
    description: "Automatic peak detection",
    longDescription:
      "Automatic adaptive Gaussian fitting algorithm for peak detection using optimization techniques to fit multiple Gaussian curves to signal data for automated spectral analysis.",
    tech: ["Signal Processing", "Optimization"],
    link: "https://github.com/TejPotu/Adaptive_gaussian_fit",
    language: "HTML",
    category: "Signal Processing",
  },
  {
    title: "Image Super Resolution",
    description: "Deep learning image enhancement",
    longDescription:
      "Deep learning approach using super-resolution neural networks to enhance low-resolution images while preserving fine details and visual fidelity.",
    tech: ["Deep Learning", "Computer Vision", "CNN"],
    link: "https://github.com/benjohnshung/SuperResolution",
    language: "Python",
...
const researchAreas = [
  {
    ...
    description:
      "Accent conversion, bandwidth extension, and speech enhancement using transformer and GAN architectures.",
    tags: ["HuBERT", "STFT", "GAN", "Transformers"],
    color: "primary" as const,
  },
  {
    title: "Deep Learning Systems",
    description:
      "Designing and training large-scale neural networks for signal processing, NLP, and computer vision tasks.",
    tags: ["PyTorch", "CNN", "GNN", "Attention"],
    color: "accent" as const,
  },
  {
    title: "AI Agents & Applications",
    description:
      "Building end-to-end AI-powered applications using LLMs, retrieval-augmented generation, and agent frameworks.",
    tags: ["LangChain", "GPT-4", "RAG", "Agents"],
    color: "primary" as const,
  },
  {
    title: "Data Science & Mining",
    description:
      "Statistical analysis, anomaly detection, and visualization of complex datasets to extract actionable insights.",
    tags: ["Scikit-learn", "Pandas", "Visualization"],
    color: "accent" as const,
  },
]
...
const skillGroups = [
  {
    label: "Languages",
    items: ["Python", "JavaScript", "TypeScript", "R", "MATLAB", "C++"],
  },
  {
    label: "ML / Deep Learning",
    items: ["PyTorch", "TensorFlow", "Scikit-learn", "HuBERT", "LangChain"],
  },
  {
    label: "Data & Visualization",
    items: ["Pandas", "NumPy", "Matplotlib", "Folium", "Seaborn"],
  },
  {
    label: "Web & Infrastructure",
    items: ["React", "Next.js", "Streamlit", "Git", "Docker"],
  },
]

const sectionIds = ["hero", "research", "projects", "skills", "contact"]
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-4 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="font-semibold text-primary">LLM Applications</span>,{" "}
            <span className="font-semibold text-primary">AI Agents</span>, and{" "}
            <span className="font-semibold text-primary">Deep Learning Systems</span>
          </p>
        ...
        <div className="mx-auto max-w-screen-xl px-6 lg:px-10">
          <div className="mb-16 max-w-2xl">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              My research interests span several domains in machine learning,
              with a particular emphasis on speech and audio intelligence.
            </p>
          </div>
      ...
      <section id="contact" className="relative z-10 scroll-mt-20 py-24 lg:py-32">
        <div className="mx-auto max-w-screen-xl px-6 lg:px-10">
          <div className="relative mx-auto max-w-2xl overflow-hidden rounded-3xl border border-border/60 bg-gradient-to-br from-primary/10 via-card/95 to-accent/10 p-12 text-center backdrop-blur-sm lg:p-16">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              {"I'm always open to discussing new research opportunities, collaborations, or interesting problems in ML and speech processing."}
            </p>
